...
struct LensLook: Identifiable {
    ...
    static let all: [LensLook] = [
        ...
        LensLook(id: "vision3", name: "Vision3 Cool Editorial", subtitle: "bläuliche Tiefen, Kino-Kontrast",
                  mul: (0.97, 1.00, 1.08), off: (-4, 0, 10), saturation: 0.90, contrast: 1.12),
        LensLook(id: "portra", name: "Kodak Portra Editorial", subtitle: "weiche, teure Hauttöne",
                  mul: (1.08, 1.02, 0.94), off: (10, 4, 0), saturation: 0.96, contrast: 0.96),
        LensLook(id: "velvia", name: "Fuji Velvia Landscape", subtitle: "knallig gesättigt",
                  mul: (1.05, 1.10, 0.98), off: (2, 4, -2), saturation: 1.35, contrast: 1.15),
        LensLook(id: "cinestill", name: "CineStill Night Glow", subtitle: "warmes Halo-Leuchten bei Nacht",
                  mul: (1.18, 0.95, 0.92), off: (14, -4, 6), saturation: 1.05, contrast: 1.05),
        LensLook(id: "hp5", name: "Ilford HP5 Reportage", subtitle: "klassisches Schwarzweiß",
                  mul: (1.00, 1.00, 1.00), off: (0, 0, 0), saturation: 0.00, contrast: 1.15),
        LensLook(id: "agfa", name: "Agfa Vista Retro", subtitle: "warmer Amateurfilm-Charme",
                  mul: (1.08, 1.03, 0.90), off: (8, 4, -4), saturation: 0.95, contrast: 0.95),
        LensLook(id: "polaroid", name: "Polaroid 600", subtitle: "pastellig, angehobenes Schwarz",
                  mul: (1.05, 1.00, 0.92), off: (18, 10, 4), saturation: 0.85, contrast: 0.85),
        LensLook(id: "leica", name: "Leica Vintage", subtitle: "warm & kontrastreich",
                  mul: (1.09, 1.00, 0.90), off: (8, 2, -6), saturation: 0.92, contrast: 1.14),
        LensLook(id: "hasselblad", name: "Hasselblad Natural", subtitle: "sanft & naturgetreu",
                  mul: (1.02, 1.01, 0.99), off: (2, 1, 0), saturation: 1.05, contrast: 1.03),
        LensLook(id: "zeiss", name: "Zeiss Cinematic", subtitle: "kühl & filmisch",
                  mul: (0.94, 1.00, 1.10), off: (-4, 0, 10), saturation: 1.00, contrast: 1.16),
        LensLook(id: "rollei", name: "Rollei Infrarot", subtitle: "feinkörnig, entrückt",
        ...
        LensLook(id: "technicolor", name: "Technicolor Bold", subtitle: "satte Primärfarben, Filmklassiker",
